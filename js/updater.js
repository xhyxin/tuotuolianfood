 ...
 *     服务端负责 测网络 -> 访问更新源比对 -> 下载改名合并 -> 返回结果；
 *  3. 直接双击 index.html（file://）：浏览器不允许跨域和写文件，
 *     提示改用「打开查询器.bat」打开（文案走 i18n，见 js/i18n.js）。
 *  更新成功后有新角色时自动刷新页面加载新数据。
 */
(function () {
  "use strict";
  var fileHint = "当前是直接双击打开的网页，浏览器不允许联网更新。" +
  ...
  window.Updater = {
    checkUpdate: function () {
      ...
      if (location.protocol === "file:") {
        if (window.I18N) fileHint = window.I18N.t("toast.update.filehint");
